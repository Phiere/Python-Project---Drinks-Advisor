...
class NotationsInteractions(QHBoxLayout):
    def __init__(self, parent, drink_name):
        ...
        self.add_favorite_button = QPushButton(' Ajouter en favori')
        self.add_favorite_button.setIcon(QIcon(self.star_icon))
        self.add_favorite_button.clicked.connect(self.toggle_favorite)
        self.is_favorite = False

        self.comment_button = QPushButton(' Commenter')
        self.comment_button.setIcon(QIcon("codes/UI/Icones/comment.png"))

        self.rate_button = QPushButton(' Noter')
        self.rate_button.setIcon(QIcon("codes/UI/Icones/rate.png"))
        self.rate_button.clicked.connect(self.open_rating_page)

        self.addWidget(self.add_favorite_button)
        self.addWidget(self.comment_button)
        self.addWidget(self.rate_button)
    ...
    def toggle_favorite(self):
        ...
        if self.is_favorite:
            self.add_favorite_button.setIcon(filled_star_icon)
        else:
            self.add_favorite_button.setIcon(self.star_icon)

    def open_rating_page(self):
        rating_page = DrinkRatingPage(self.drink_name, self.parent.size())
        rating_page.show()
